...
public class BoatDeathListener implements IWorldEventListener {
    private static final BoatDeathListener INSTANCE = new BoatDeathListener();

    public static BoatDeathListener getInstance() {
        return INSTANCE;
    }

    private BoatDeathListener() {}
